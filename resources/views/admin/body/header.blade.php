            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ !empty($admin->photo) ?
                                 url('upload/admin_images/'.$admin->photo) : url('upload/no_image.jpg')}}"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="javascript:void(0)" onclick="$(this).parent().find('form#logout').submit()"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
